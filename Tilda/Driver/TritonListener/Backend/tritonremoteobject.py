...
class TritonRemoteObject:
    ...
    def __getattr__(self, item):
        # this method returns the _call_remote_ method (without calling it), but predefines the item argument.
        return functools.partial(self._call_remote_, item=item)
    ...
    def _call_remote_(self, *args, item):
        ...
        return self.__send_msg_to_server_and_wait_for_reply(
            self.__remoteip, self.__remoteport, msg_bytes=bits, msg_type=SERVER_CONF.REMOTE_CALL)

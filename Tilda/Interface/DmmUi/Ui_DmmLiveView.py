...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_pulse_len_and_timeout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_wait_after_switchbox)
        ...
        self.formLayout_pulse_len_and_timeout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.doubleSpinBox_wait_after_switchbox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_wait_after_switchbox.setText(_translate("MainWindow", "wait after switchbox changed [s]"))

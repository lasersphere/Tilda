...
class Ui_JobStacker(object):
    def setupUi(self, JobStacker):
        ...
        JobStacker.resize(407, 364)
        self.centralwidget = QtWidgets.QWidget(JobStacker)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.centralwidget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.label_formatexplain = QtWidgets.QLabel(self.centralwidget)
        self.label_formatexplain.setObjectName("label_formatexplain")
        self.verticalLayout.addWidget(self.label_formatexplain)
        self.label_infostring = QtWidgets.QLabel(self.centralwidget)
        self.label_infostring.setObjectName("label_infostring")
        self.verticalLayout.addWidget(self.label_infostring)
    ...
    def retranslateUi(self, JobStacker):
        ...
        self.label_formatexplain.setText(_translate("JobStacker", "Format: iso_name | seq_type | #reps_as_go | #reps_new_file"))
        self.label_infostring.setText(_translate("JobStacker", "Not working on jobs. Click run to start."))

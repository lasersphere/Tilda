...
from Tilda.Interface.TildaPassiveUi.Ui_TildaPassive import Ui_TildaPassiveMainWindow
...
class TildaPassiveUi(QtWidgets.QMainWindow, Ui_TildaPassiveMainWindow):
    ...
    def load_settings(self):
        try:
            data = FileHandle.loadPickle(self.settings_path)
    ...
    def save_settings(self):
        ...
        FileHandle.save_pickle_simple(self.settings_path, data)

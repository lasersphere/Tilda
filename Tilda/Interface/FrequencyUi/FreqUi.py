...
from Tilda.Interface.FrequencyUi.Ui_Frequency import Ui_Frequency
from Tilda.Interface.FrequencyUi.AddFreqUi import AddFreqUi
...
class FreqUi(QtWidgets.QMainWindow, Ui_Frequency):
    ...
    def edit_freq(self):
        ...
        try:
            ...
            if self.new_freq_name is not None:  # if frequency added in the dialog, add to listvi                                                                                                                                                                                                                                                                                                                                ew

...
from Tilda.Interface.LiveDataPlottingUi.MakePrePostGrid import PrePostGridWidget
from Tilda.Interface.LiveDataPlottingUi.PreDurPostPlotter import PreDurPostPlotter
...
class PrePostTabWidget(QtWidgets.QTabWidget):
    ...
    def add_pre_dur_post_form(self, pre_dur_post_str, parent_layout, index, tr_name):
        ...
        parent_layout.setWidget(index, QtWidgets.QFormLayout.ItemRole.LabelRole, pre_post_label)
        ...
        parent_layout.setWidget(index, QtWidgets.QFormLayout.ItemRole.FieldRole, pre_post_during_grid_widget)
        # ---------- add divider line ---------
        index += 1  # add new line to the Form
        ...
        parent_layout.setWidget(index, QtWidgets.QFormLayout.ItemRole.FieldRole, line_hor_divide)
        index += 1

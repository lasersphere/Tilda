...
from Tilda.Application.Main.MainState import MainState
from Tilda.Application.Options import Options

import Tilda.Service.DatabaseOperations.DatabaseOperations as DbOp
...
from Tilda.Service.AnalysisAndDataHandling.DisplayData import DisplayData
from Tilda.Service.Scan.ScanMain import ScanMain
from Tilda.Service.SimpleCounter.SimpleCounter import SimpleCounterControl
...
class Main(QtCore.QObject):
    ...
    def __init__(self):
        ...
        self.options_file_path = os.path.join(Cfg.config_dir, 'options.yaml')
    ...
    def autostart(self):
        ...
        path = FileHandle.write_to_auto_start_xml_file()
        root_ele, autostart_tpl = FileHandle.load_auto_start_xml_file(path)
    ...
    def pause_scan(self, pause_scan_bool=None):
        ...
        :param pause_scan_bool: bool, None if you want to toggle
        """

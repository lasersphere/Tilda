...
from Tilda.PolliFit.TildaTools import get_number_of_tracks_in_scan_dict
...
def init_empty_scan_dict(type_str=None, version=None, load_default_vals=False):
    ...
    Only the version information is already filled in from Tilda.Application.Config.
    """
    ...
    scand['track0']['trigger'] = {'meas_trigger': {'type': TriTyp.no_trigger},
                                  'step_trigger': {'type': TriTyp.no_trigger},
                                  'scan_trigger': {'type': TriTyp.no_trigger}}

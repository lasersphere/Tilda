...
from Tilda.PolliFit.Models.Base import Model
from Tilda.PolliFit.Models.Spectrum import Gauss, Lorentz, GaussChi2, source_energy_pdf
...
class Convolved(Model):
    ...
    def intervals(self):
        return Tools.merge_intervals([[i[0] + self.model_1.min(), i[1] + self.model_1.max()]

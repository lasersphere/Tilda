...
# Form implementation generated from reading ui file 'D:\Users\Patrick\Dokumente\Python Projects\TildaDevel\Tilda\PolliFit\Gui\Ui_Crawler.ui'
#
...
class Ui_Crawler(object):
    def setupUi(self, Crawler):
        ...
        self.hor_load_channels = QtWidgets.QHBoxLayout()
        self.hor_load_channels.setObjectName("hor_load_channels")
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.hor_load_channels.addItem(spacerItem)
        self.l_load_channels = QtWidgets.QLabel(Crawler)
        self.l_load_channels.setStyleSheet("color: rgb(255, 0, 0);")
        self.l_load_channels.setText("")
        self.l_load_channels.setObjectName("l_load_channels")
        self.hor_load_channels.addWidget(self.l_load_channels)
        self.b_load_channels = QtWidgets.QPushButton(Crawler)
        self.b_load_channels.setMinimumSize(QtCore.QSize(120, 0))
        self.b_load_channels.setObjectName("b_load_channels")
        self.hor_load_channels.addWidget(self.b_load_channels)
        self.verticalLayout.addLayout(self.hor_load_channels)
        self.hor_acc_voltage = QtWidgets.QHBoxLayout()
        self.hor_acc_voltage.setObjectName("hor_acc_voltage")
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.hor_acc_voltage.addItem(spacerItem1)
        ...
        self.hor_off_voltage.addItem(spacerItem2)
        ...
        self.hor_laser.addItem(spacerItem3)
    ...
    def retranslateUi(self, Crawler):
        ...
        self.b_load_channels.setText(_translate("Crawler", "Load channels"))

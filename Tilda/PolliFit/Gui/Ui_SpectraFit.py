...
# Form implementation generated from reading ui file 'D:\Users\Patrick\Dokumente\Python Projects\TildaDevel\Tilda\PolliFit\Gui\Ui_SpectraFit.ui'
#
...
class Ui_SpectraFit(object):
    def setupUi(self, SpectraFit):
        ...
        self.vert_options.setGeometry(QtCore.QRect(0, 0, 281, 601))
        ...
        self.grid_fit_layout.addWidget(self.check_linked, 7, 1, 1, 1)
        ...
        self.grid_fit_layout.addLayout(self.hor_trsplot, 5, 1, 1, 1)
        ...
        self.grid_fit_layout.addLayout(self.hor_trs, 5, 0, 1, 1)
        self.check_save_to_db = QtWidgets.QCheckBox(self.grid_fit)
        self.check_save_to_db.setObjectName("check_save_to_db")
        self.grid_fit_layout.addWidget(self.check_save_to_db, 9, 0, 1, 1)
        ...
        self.grid_fit_layout.addWidget(self.check_summed, 7, 0, 1, 1)
        ...
        self.grid_fit_layout.addLayout(self.hor_arithmetics, 4, 1, 1, 1)
        ...
        self.grid_fit_layout.addLayout(self.hor_adjust, 8, 0, 1, 1)
        ...
        self.check_x_as_freq.setEnabled(False)
        self.check_x_as_freq.setTristate(True)
    ...
    def retranslateUi(self, SpectraFit):
        ...
        self.c_xaxis.setItemText(2, _translate("SpectraFit", "DAC voltages"))
        self.c_xaxis.setItemText(3, _translate("SpectraFit", "voltages"))
        ...
        self.check_chi2.setToolTip(_translate("SpectraFit", "Scale the covariance matrix for <nobr>&chi; <sup>2</sup> = 1</nobr>."))
        ...
        self.check_delta_f.setToolTip(_translate("SpectraFit", "<html><head/><body><p>Calculate the y-axis uncertainties from the fit function. This yields better agreement with data for low statistics (y &lt; 10). Option not available if arithmetics is not a list of scalers.</p></body></html>"))
        self.l_delta_f.setToolTip(_translate("SpectraFit", "<html><head/><body><p>Calculate the y-axis uncertainties from the fit function. This yields better agreement with data for low numbers of counts. Option not available if arithmetics is not a list of scalers.</p></body></html>"))
        self.l_delta_f.setText(_translate("SpectraFit", "<nobr>&Delta; from fit (Poisson)</nobr>"))

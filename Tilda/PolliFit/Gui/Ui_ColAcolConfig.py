...
class Ui_ColAcolConfig(object):
    ...
    def retranslateUi(self, ColAcolConfig):
        ...
        self.c_parameter.setToolTip(_translate("ColAcolConfig", "Parameter treated as the resonance position relative to the \'frequency\' specified in the \'Lines\' table of the database."))
        self.l_iterate.setText(_translate("ColAcolConfig", "Iterate max."))
        self.s_iterate.setToolTip(_translate("ColAcolConfig", "Number of maximum iterations."))
        ...
        self.d_mhz.setToolTip(_translate("ColAcolConfig", "Iterate until col/acol resonances are below specified value apart from each other."))
        self.d_mhz.setSuffix(_translate("ColAcolConfig", " MHz"))
        self.check_mc.setToolTip(_translate("ColAcolConfig", "Use Monte-Carlo sampling to determine the uncertainties of absolute transition frequencies."))
        self.check_mc.setText(_translate("ColAcolConfig", "MC uncertainties?"))
        self.s_mc.setToolTip(_translate("ColAcolConfig", "The number of samples."))

...
import ast
import sqlite3
from Tilda.PolliFit import TildaTools as TiTs, Tools, Physics
from Tilda.PolliFit.DBIsotope import DBIsotope
from Tilda.PolliFit.Gui.Ui_Simulation import Ui_Simulation
...
class SimulationUi(QtWidgets.QWidget, Ui_Simulation):
    ...
    def load_parameters(self):
        ...
        if line and iso:
            ...
            model = import_module('Tilda.PolliFit.Spectra.{}'.format(self.line))

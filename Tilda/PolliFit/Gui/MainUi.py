...
from Tilda.PolliFit import Tools, MPLPlotter as Plot
from Tilda.PolliFit.Gui.Ui_Main import Ui_MainWindow
...
class MainUi(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, db_path, parent=None, overwrite_stdout=True):
        ...
        self.spectrafit.con_main_tilda_gui(self.parent_win)
    ...
    def save_db_path_to_text_file(self):
        txt_file = os.path.normpath(os.path.join(Cfg.config_dir, 'PolliFit', 'current_db_loc.txt'))

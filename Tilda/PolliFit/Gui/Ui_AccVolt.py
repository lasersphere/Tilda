...
class Ui_AccVolt(object):
    def setupUi(self, AccVolt):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lineEdit_avg)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lineEdit_rChi2)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lineEdit_statErr)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lineEdit_readErr)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lineEdit_savedto)
        self.dateTimeEdit_start = QtWidgets.QDateTimeEdit(AccVolt)
        self.dateTimeEdit_start.setObjectName("dateTimeEdit_start")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.dateTimeEdit_start)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.dateTimeEdit_end)

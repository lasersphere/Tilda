...
def isoPlot(db, iso_name, isovar = '', linevar = '', as_freq=True, laserfreq=None, col=None, saving=False, show=True, isom=None):
    '''plot isotope iso'''
    ...
    if isom:
        isoPlot(db, isom, isovar, linevar, as_freq, laserfreq, col, saving, show)
    else:
        if saving:

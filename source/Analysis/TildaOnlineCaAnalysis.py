...
#
files = ['cs_40_Ca_broad_000.xml', 'cs_40_Ca_broad_003.xml',
         'cs_40_Ca_broad_006.xml', 'cs_40_Ca_broad_007.xml',
         'trs_40_Ca_001.xml', 'trs_40_Ca_002.xml', 'trs_40_Ca_003.xml',
         'trs_40_Ca_004.xml', 'trs_40_Ca_005.xml', 'trs_40_Ca_006.xml',
         'trs_40_Ca_007.xml', 'trs_40_Ca_008.xml', 'trs_40_Ca_011.xml'
         ]
# files = ['cs_40_Ca_broad_003.xml',
#          'trs_40_Ca_001.xml', 'trs_40_Ca_002.xml', 'trs_40_Ca_003.xml'
#          ]
# files = [files[-1]]
# fit = InteractiveFit(files[-3], db, 'sc0+sc1', block=True)
# fit.fit()

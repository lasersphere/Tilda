...
db = 'R:\Projekte\TRIGA\Measurements and Analysis_Simon\Bunchermessungen2016' + \
     '\CalciumOnline_160303_analysis\CalciumOnline_160303_analysis_7.sqlite'


""" folder """
work_dir = os.path.split(db)[0]
combine_plots_dir = os.path.join(work_dir, 'combined_plots_7')
...
#
files = ['40_Ca_cs_012.xml', '40_Ca_cs_013.xml', '40_Ca_cs_014.xml', '40_Ca_cs_015.xml',
         '40_Ca_cs_016.xml', '40_Ca_cs_017.xml', '40_Ca_cs_018.xml', '40_Ca_cs_019.xml',
         '40_Ca_cs_020.xml', '40_Ca_cs_021.xml', '40_Ca_cs_022.xml', '40_Ca_cs_023.xml',
         '40_Ca_trs_077.xml', '40_Ca_trs_081.xml',
         '40_Ca_cs_025.xml'
         ]

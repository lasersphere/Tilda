...
'''Bitfile Signature:'''
bitfileSignatures = {'PXI-7852R': 'ACCE086349543E323BB99D74C50D341D',
                     'PXI-7841R': '74FD6013D002029BE951059460006FA1'
                     }
...
bitfilePaths = {'PXI-7852R': path.join(path.dirname(__file__), pardir, pardir, pardir, pardir,
                                       'TildaTarget/bin/ContinousSequencer/NiFpga_ContSeqV203.lvbitx'),
                'PXI-7841R': path.join(path.dirname(__file__), pardir, pardir, pardir, pardir,
                                       'TildaTarget/bin/ContinousSequencer/NiFpga_ContSeqV203_7841.lvbitx')
                }
...
SPerrorCount = {'ref': 0x812E, 'val': ctypes.c_ubyte(), 'ctr': False}
postAccOffsetVoltState = {'ref': 0x8126, 'val': ctypes.c_ubyte(), 'ctr': False}
SPstate = {'ref': 0x8132, 'val': ctypes.c_uint(), 'ctr': False}
measVoltState = {'ref': 0x817A, 'val': ctypes.c_uint(), 'ctr': False}
seqState = {'ref': 0x8166, 'val': ctypes.c_uint(), 'ctr': False}
'''Controls:'''
VoltOrScaler = {'ref': 0x810E, 'val': ctypes.c_bool(), 'ctr': True}
abort = {'ref': 0x816E, 'val': ctypes.c_bool(), 'ctr': True}
halt = {'ref': 0x8172, 'val': ctypes.c_bool(), 'ctr': True}
hostConfirmsHzOffsetIsSet = {'ref': 0x8176, 'val': ctypes.c_bool(), 'ctr': True}
invertScan = {'ref': 0x814E, 'val': ctypes.c_bool(), 'ctr': True}
timedOutWhileHandshake = {'ref': 0x8162, 'val': ctypes.c_bool(), 'ctr': True}
postAccOffsetVoltControl = {'ref': 0x812A, 'val': ctypes.c_ubyte(), 'ctr': True}
selectTrigger = {'ref': 0x811E, 'val': ctypes.c_ubyte(), 'ctr': True}
triggerEdge = {'ref': 0x8116, 'val': ctypes.c_ubyte(), 'ctr': True}
cmdByHost = {'ref': 0x816A, 'val': ctypes.c_uint(), 'ctr': True}
triggerTypes = {'ref': 0x8122, 'val': ctypes.c_uint(), 'ctr': True}
waitAfterReset25nsTicks = {'ref': 0x8156, 'val': ctypes.c_uint(), 'ctr': True}
waitForKepco25nsTicks = {'ref': 0x8152, 'val': ctypes.c_uint(), 'ctr': True}
dacStartRegister18Bit = {'ref': 0x8140, 'val': ctypes.c_long(), 'ctr': True}
dacStepSize18Bit = {'ref': 0x813C, 'val': ctypes.c_long(), 'ctr': True}
measVoltPulseLength25ns = {'ref': 0x8158, 'val': ctypes.c_long(), 'ctr': True}
measVoltTimeout10ns = {'ref': 0x815C, 'val': ctypes.c_long(), 'ctr': True}
nOfScans = {'ref': 0x8148, 'val': ctypes.c_long(), 'ctr': True}
nOfSteps = {'ref': 0x8144, 'val': ctypes.c_long(), 'ctr': True}
dac0VRegister = {'ref': 0x8110, 'val': ctypes.c_ulong(), 'ctr': True}
dwellTime10ns = {'ref': 0x8134, 'val': ctypes.c_ulong(), 'ctr': True}
trigDelay10ns = {'ref': 0x8118, 'val': ctypes.c_ulong(), 'ctr': True}
'''TargetToHostFifos:'''

...
'''Bitfile Signature:'''
bitfileSignatures = {'PXI-7852R': 'A9AE10F004577AFB70CE27A9231B2DAE',
                     'PXI-7841R': 'EEF2FB78C5318BF34D4693BDD49592DA'
                     }
...
bitfilePaths = {'PXI-7852R': path.join(path.dirname(__file__), pardir, pardir, pardir, pardir,
                                       'TildaTarget/bin/ContinousSequencer/NiFpga_ContSeqV205.lvbitx'),
                'PXI-7841R': path.join(path.dirname(__file__), pardir, pardir, pardir, pardir,
                                       'TildaTarget/bin/ContinousSequencer/NiFpga_ContSeqV205_7841.lvbitx')
                }
bitfilePath = bitfilePaths[fpga_type]
'''FPGA Resource:'''
fpgaResource = fpga_resource
'''Indicators:'''
DACQuWriteTimeout = {'ref': 0x818A, 'val': ctypes.c_bool(), 'ctr': False}
SPCtrQuWriteTimeout = {'ref': 0x8146, 'val': ctypes.c_bool(), 'ctr': False}
SPerrorCount = {'ref': 0x813A, 'val': ctypes.c_ubyte(), 'ctr': False}
postAccOffsetVoltState = {'ref': 0x8132, 'val': ctypes.c_ubyte(), 'ctr': False}
SPstate = {'ref': 0x813E, 'val': ctypes.c_uint(), 'ctr': False}
measVoltState = {'ref': 0x8186, 'val': ctypes.c_uint(), 'ctr': False}
seqState = {'ref': 0x8172, 'val': ctypes.c_uint(), 'ctr': False}
'''Controls:'''
VoltOrScaler = {'ref': 0x810E, 'val': ctypes.c_bool(), 'ctr': True}
abort = {'ref': 0x817A, 'val': ctypes.c_bool(), 'ctr': True}
halt = {'ref': 0x817E, 'val': ctypes.c_bool(), 'ctr': True}
hostConfirmsHzOffsetIsSet = {'ref': 0x8182, 'val': ctypes.c_bool(), 'ctr': True}
invertScan = {'ref': 0x815A, 'val': ctypes.c_bool(), 'ctr': True}
pause = {'ref': 0x8112, 'val': ctypes.c_bool(), 'ctr': True}
stopVoltMeas = {'ref': 0x8116, 'val': ctypes.c_bool(), 'ctr': True}
timedOutWhileHandshake = {'ref': 0x816E, 'val': ctypes.c_bool(), 'ctr': True}
postAccOffsetVoltControl = {'ref': 0x8136, 'val': ctypes.c_ubyte(), 'ctr': True}
selectTrigger = {'ref': 0x812A, 'val': ctypes.c_ubyte(), 'ctr': True}
triggerEdge = {'ref': 0x8122, 'val': ctypes.c_ubyte(), 'ctr': True}
cmdByHost = {'ref': 0x8176, 'val': ctypes.c_uint(), 'ctr': True}
measVoltCompleteDest = {'ref': 0x811A, 'val': ctypes.c_uint(), 'ctr': True}
triggerTypes = {'ref': 0x812E, 'val': ctypes.c_uint(), 'ctr': True}
waitAfterReset25nsTicks = {'ref': 0x8162, 'val': ctypes.c_uint(), 'ctr': True}
waitForKepco25nsTicks = {'ref': 0x815E, 'val': ctypes.c_uint(), 'ctr': True}
dacStartRegister18Bit = {'ref': 0x814C, 'val': ctypes.c_long(), 'ctr': True}
dacStepSize18Bit = {'ref': 0x8148, 'val': ctypes.c_long(), 'ctr': True}
measVoltPulseLength25ns = {'ref': 0x8164, 'val': ctypes.c_long(), 'ctr': True}
measVoltTimeout10ns = {'ref': 0x8168, 'val': ctypes.c_long(), 'ctr': True}
nOfScans = {'ref': 0x8154, 'val': ctypes.c_long(), 'ctr': True}
nOfSteps = {'ref': 0x8150, 'val': ctypes.c_long(), 'ctr': True}
dac0VRegister = {'ref': 0x811C, 'val': ctypes.c_ulong(), 'ctr': True}
dwellTime10ns = {'ref': 0x8140, 'val': ctypes.c_ulong(), 'ctr': True}
trigDelay10ns = {'ref': 0x8124, 'val': ctypes.c_ulong(), 'ctr': True}
'''TargetToHostFifos:'''

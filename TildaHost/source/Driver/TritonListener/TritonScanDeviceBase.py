...
copied from Triton on 02.03.19 git rev. number: 93bfb2224b229c100be7ca80317eda21289f7282
...
class ScanDeviceBase(DeviceBase):
    def __init__(self, name, sql_conf):
        ...
        self.dev_max_step_size = float('inf')  # float, maximum stepsize
        self.dev_min_val = float('-inf')  # float, minimal value that can be set with this device
        self.dev_max_val = float('inf')  # float, minimal value that can be set with this device

...
class Ui_Dialog_simpleCounterControl(object):
    def setupUi(self, Dialog_simpleCounterControl):
        ...
        Dialog_simpleCounterControl.resize(555, 377)
        ...
        self.buttonBox.setGeometry(QtCore.QRect(380, 340, 156, 23))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.widget = QtWidgets.QWidget(Dialog_simpleCounterControl)
        self.widget.setGeometry(QtCore.QRect(10, 60, 531, 271))
        ...
        self.verticalLayout_4.addWidget(self.widget_timeGate_place_holder)

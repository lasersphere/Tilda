...
class Ui_SetupIsotope(object):
    def setupUi(self, SetupIsotope):
        ...
        self.comboBox_sequencer_select.addItem("")
        self.comboBox_sequencer_select.addItem("")
        self.comboBox_sequencer_select.addItem("")
    ...
    def retranslateUi(self, SetupIsotope):
        ...
        self.comboBox_sequencer_select.setItemText(0, _translate("SetupIsotope", "continous"))
        self.comboBox_sequencer_select.setItemText(1, _translate("SetupIsotope", "time resolved"))
        self.comboBox_sequencer_select.setItemText(2, _translate("SetupIsotope", "kepco scan"))

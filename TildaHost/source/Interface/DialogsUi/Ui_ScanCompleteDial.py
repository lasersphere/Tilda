...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        brush = QtGui.QBrush(QtGui.QColor(0, 167, 0, 150))
        brush.setStyle(QtCore.Qt.SolidPattern)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Scan complete!"))
        self.checkBox.setText(_translate("Dialog", "do not show in the future"))

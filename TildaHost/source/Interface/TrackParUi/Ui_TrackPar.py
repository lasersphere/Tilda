...
class Ui_MainWindowTrackPars(object):
    def setupUi(self, MainWindowTrackPars):
        ...
        MainWindowTrackPars.resize(413, 663)
        icon = QtGui.QIcon()
        ...
        self.doubleSpinBox_waitAfterReset_muS.setMaximum(4294967295.0)
        self.doubleSpinBox_waitAfterReset_muS.setSingleStep(10.0)
        ...
        self.doubleSpinBox_waitForKepco_muS.setDecimals(0)
        self.doubleSpinBox_waitForKepco_muS.setMaximum(4294967295.0)
        self.doubleSpinBox_waitForKepco_muS.setSingleStep(10.0)

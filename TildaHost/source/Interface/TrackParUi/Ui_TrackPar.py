...
class Ui_MainWindowTrackPars(object):
    def setupUi(self, MainWindowTrackPars):
        ...
        self.specificSeqeuncerSettings = QtWidgets.QWidget(self.centralwidget)
        self.specificSeqeuncerSettings.setObjectName("specificSeqeuncerSettings")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.specificSeqeuncerSettings)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.label = QtWidgets.QLabel(self.specificSeqeuncerSettings)
        ...
        self.label_dwellTime_ms = QtWidgets.QLabel(self.specificSeqeuncerSettings)
        self.label_dwellTime_ms.setObjectName("label_dwellTime_ms")
        self.gridLayout.addWidget(self.label_dwellTime_ms, 1, 0, 1, 1)
        self.doubleSpinBox_dwellTime_ms = QtWidgets.QDoubleSpinBox(self.specificSeqeuncerSettings)
        ...
        self.label_dwellTime_ms_2 = QtWidgets.QLabel(self.specificSeqeuncerSettings)
        self.label_dwellTime_ms_2.setObjectName("label_dwellTime_ms_2")
        self.gridLayout.addWidget(self.label_dwellTime_ms_2, 1, 2, 1, 1)
        self.label_8 = QtWidgets.QLabel(self.specificSeqeuncerSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_9 = QtWidgets.QLabel(self.specificSeqeuncerSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_10 = QtWidgets.QLabel(self.specificSeqeuncerSettings)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout.addWidget(self.specificSeqeuncerSettings)
        ...
        self.label_measVoltTimeout_muS = QtWidgets.QLabel(self.advancedSeqSettings)
        self.label_measVoltTimeout_muS.setObjectName("label_measVoltTimeout_muS")
        self.gridLayout_5.addWidget(self.label_measVoltTimeout_muS, 4, 0, 1, 1)
        ...
        self.label_measVoltPulseLength_muS = QtWidgets.QLabel(self.advancedSeqSettings)
        self.label_measVoltPulseLength_muS.setObjectName("label_measVoltPulseLength_muS")
        self.gridLayout_5.addWidget(self.label_measVoltPulseLength_muS, 3, 0, 1, 1)
        ...
        self.doubleSpinBox_measVoltPulseLength_muS = QtWidgets.QDoubleSpinBox(self.advancedSeqSettings)
        self.doubleSpinBox_measVoltPulseLength_muS.setFrame(True)
        self.doubleSpinBox_measVoltPulseLength_muS.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.doubleSpinBox_measVoltPulseLength_muS.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.doubleSpinBox_measVoltPulseLength_muS.setKeyboardTracking(False)
        self.doubleSpinBox_measVoltPulseLength_muS.setDecimals(3)
        self.doubleSpinBox_measVoltPulseLength_muS.setMaximum(10000.0)
        self.doubleSpinBox_measVoltPulseLength_muS.setSingleStep(0.5)
        self.doubleSpinBox_measVoltPulseLength_muS.setObjectName("doubleSpinBox_measVoltPulseLength_muS")
        self.gridLayout_5.addWidget(self.doubleSpinBox_measVoltPulseLength_muS, 3, 1, 1, 1)
        self.doubleSpinBox_measVoltTimeout_muS = QtWidgets.QDoubleSpinBox(self.advancedSeqSettings)
        self.doubleSpinBox_measVoltTimeout_muS.setFrame(True)
        self.doubleSpinBox_measVoltTimeout_muS.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.doubleSpinBox_measVoltTimeout_muS.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.doubleSpinBox_measVoltTimeout_muS.setKeyboardTracking(False)
        self.doubleSpinBox_measVoltTimeout_muS.setDecimals(3)
        self.doubleSpinBox_measVoltTimeout_muS.setMaximum(10000.0)
        self.doubleSpinBox_measVoltTimeout_muS.setSingleStep(0.5)
        self.doubleSpinBox_measVoltTimeout_muS.setObjectName("doubleSpinBox_measVoltTimeout_muS")
        self.gridLayout_5.addWidget(self.doubleSpinBox_measVoltTimeout_muS, 4, 1, 1, 1)
        ...
        self.label_measVoltPulseLength_muS_set = QtWidgets.QLabel(self.advancedSeqSettings)
        self.label_measVoltPulseLength_muS_set.setObjectName("label_measVoltPulseLength_muS_set")
        self.gridLayout_5.addWidget(self.label_measVoltPulseLength_muS_set, 3, 2, 1, 1)
        self.label_measVoltTimeout_muS_set = QtWidgets.QLabel(self.advancedSeqSettings)
        self.label_measVoltTimeout_muS_set.setObjectName("label_measVoltTimeout_muS_set")
        self.gridLayout_5.addWidget(self.label_measVoltTimeout_muS_set, 4, 2, 1, 1)
...
"Voltage:"))
        ...
        self.label_measVoltTimeout_muS.setText(_translate("MainWindowTrackPars", "timeout for volt meas [µs]"))
        self.label_waitForKepco_muS_set.setText(_translate("MainWindowTrackPars", "0"))
        self.label_measVoltPulseLength_muS.setText(_translate("MainWindowTrackPars", "volt meas pulse length [µs]"))
        ...
        self.label_waitAfterReset_muS_set.setText(_translate("MainWindowTrackPars", "0"))
        self.label_measVoltPulseLength_muS_set.setText(_translate("MainWindowTrackPars", "0"))
        self.label_measVoltTimeout_muS_set.setText(_translate("MainWindowTrackPars", "0"))

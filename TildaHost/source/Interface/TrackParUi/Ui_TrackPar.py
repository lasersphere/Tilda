...
class Ui_MainWindowTrackPars(object):
    def setupUi(self, MainWindowTrackPars):
        ...
        MainWindowTrackPars.resize(391, 472)
        icon = QtGui.QIcon()
        ...
        MainWindowTrackPars.setTabOrder(self.doubleSpinBox_dwellTime_ms, self.doubleSpinBox_dacStartV)
        ...
        MainWindowTrackPars.setTabOrder(self.checkBox_invertScan, self.spinBox_postAccOffsetVoltControl)
        MainWindowTrackPars.setTabOrder(self.spinBox_postAccOffsetVoltControl, self.doubleSpinBox_postAccOffsetVolt)
        ...
        MainWindowTrackPars.setTabOrder(self.checkBox_colDirTrue, self.pushButton_advancedSettings)
        MainWindowTrackPars.setTabOrder(self.pushButton_advancedSettings, self.pushButton_cancel)
        MainWindowTrackPars.setTabOrder(self.pushButton_cancel, self.pushButton_confirm)

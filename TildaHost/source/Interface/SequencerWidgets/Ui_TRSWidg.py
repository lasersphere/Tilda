...
class Ui_TRSWidg(object):
    def setupUi(self, TRSWidg):
        ...
        self.gridLayout.addWidget(self.spinBox_nOfBunches, 3, 1, 1, 1)
        self.label_nOfBunches_set = QtWidgets.QLabel(TRSWidg)
        self.label_nOfBunches_set.setObjectName("label_nOfBunches_set")
        self.gridLayout.addWidget(self.label_nOfBunches_set, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_softwGates_set, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_softBinWidth_set, 2, 2, 1, 1)

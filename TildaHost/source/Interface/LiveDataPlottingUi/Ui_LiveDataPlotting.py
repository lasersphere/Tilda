...
class Ui_MainWindow_LiveDataPlotting(object):
    def setupUi(self, MainWindow_LiveDataPlotting):
        ...
        self.checkBox_sum_zoom = QtWidgets.QCheckBox(self.tab_timeres)
        self.checkBox_sum_zoom.setObjectName("checkBox_sum_zoom")
        self.gridLayout.addWidget(self.checkBox_sum_zoom, 1, 0, 1, 1)
        self.checkBox_volt_line_zoom = QtWidgets.QCheckBox(self.tab_timeres)
        self.checkBox_volt_line_zoom.setObjectName("checkBox_volt_line_zoom")
        self.gridLayout.addWidget(self.checkBox_volt_line_zoom, 1, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow_LiveDataPlotting):
        ...
        self.checkBox_sum_zoom.setText(_translate("MainWindow_LiveDataPlotting", "sum is zoomable"))
        self.checkBox_volt_line_zoom.setText(_translate("MainWindow_LiveDataPlotting", "volt projection is zoomable"))

...
# Form implementation generated from reading ui file 'D:\Users\Patrick\Dokumente\Python Projects\Tilda\TildaHost\source\Interface\LiveDataPlottingUi\Ui_LiveDataPlotting.ui'
#
...
class Ui_MainWindow_LiveDataPlotting(object):
    def setupUi(self, MainWindow_LiveDataPlotting):
        ...
        self.menunorm = QtWidgets.QMenu(self.menuEdit)
        ...
        self.action_screenshot = QtWidgets.QAction(MainWindow_LiveDataPlotting)
        self.action_screenshot.setObjectName("action_screenshot")
        self.action_screenshot_all = QtWidgets.QAction(MainWindow_LiveDataPlotting)
        self.action_screenshot_all.setObjectName("action_screenshot_all")
        self.menuView.addAction(self.actionProgress)
        self.menuView.addAction(self.action_screenshot)
        self.menuView.addAction(self.action_screenshot_all)
        ...
        self.menuEdit.addAction(self.menunorm.menuAction())
        self.menuEdit.addAction(self.actionshow_bins)
    ...
    def retranslateUi(self, MainWindow_LiveDataPlotting):
        ...
        self.menunorm.setTitle(_translate("MainWindow_LiveDataPlotting", "norm PMTs to"))
        ...
        self.action_screenshot.setText(_translate("MainWindow_LiveDataPlotting", "screenshot"))
        self.action_screenshot.setShortcut(_translate("MainWindow_LiveDataPlotting", "Ctrl+C"))
        self.action_screenshot_all.setText(_translate("MainWindow_LiveDataPlotting", "screenshot all"))
        self.action_screenshot_all.setShortcut(_translate("MainWindow_LiveDataPlotting", "Ctrl+Shift+C"))

...
NiFpga_TRS_ControlU16_cmdByHost= {'ref': 0x8142, 'val': ctypes.c_bool()}
vgl = ctypes.c_ubyte
print(type(NiFpga_TRS_ControlU16_cmdByHost['val']))
print(type(NiFpga_TRS_ControlU16_cmdByHost['val'])== ctypes.c_ushort)

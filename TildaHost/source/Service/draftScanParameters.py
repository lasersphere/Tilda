...
draftTrackPars = {'measVoltPulseLength25ns': 400, 'measVoltTimeout10ns': 100,
                   'VoltOrScaler': False,
                   'stepSize': form.get24BitInputForVoltage(1, False),
                   'start': form.get24BitInputForVoltage(-5, False),
                   'nOfSteps': 20,
                   'nOfScans': 30, 'nOfCompletedSteps': 0, 'invertScan': False,
                   'measureOffset': False, 'heinzingerControl': 2, 'heinzingerOffsetVolt': 1000,

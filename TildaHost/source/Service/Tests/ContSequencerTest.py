...
from Service.VoltageConversions.VoltageConversions import get_bits_from_voltage, get_stepsize_in_bits
...
scanPars['track0']['dacStepSize18Bit'] = get_stepsize_in_bits(0.02)
scanPars['track0']['dacStartRegister18Bit'] = get_bits_from_voltage(-10)

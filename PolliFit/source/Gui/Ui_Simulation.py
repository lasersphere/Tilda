...
# Form implementation generated from reading ui file 'D:\Users\Patrick\Dokumente\Python Projects\Tilda\PolliFit\source\Gui\Ui_Simulation.ui'
#
...
class Ui_Simulation(object):
    ...
    def retranslateUi(self, Simulation):
        ...
        self.cAcolFreq.setText(_translate("Simulation", "ACol. LaserFreq."))
        self.dColFreq.setSuffix(_translate("Simulation", " MHz"))
        self.label_2.setText(_translate("Simulation", "LineVar:"))
        self.cColFreq.setText(_translate("Simulation", "Col. LaserFreq."))
        self.dAccVolt.setSuffix(_translate("Simulation", " V"))
        self.label_4.setText(_translate("Simulation", "u\"\\u22C5\" U + ("))

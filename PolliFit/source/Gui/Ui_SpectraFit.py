...
class Ui_SpectraFit(object):
    def setupUi(self, SpectraFit):
        ...
        self.hor_file_options.setGeometry(QtCore.QRect(0, 0, 294, 45))
        ...
        self.hor_parameters.setGeometry(QtCore.QRect(0, 0, 428, 45))
        ...
        self.grid_fit_layout.addWidget(self.check_save_figure, 5, 1, 1, 1)

...
class Ui_SpectraFit(object):
    def setupUi(self, SpectraFit):
        ...
        self.grid_model.addWidget(self.check_offset_per_track, 3, 0, 1, 1)
        ...
        self.grid_model.addWidget(self.check_hf_mixing, 4, 1, 1, 1)
        ...
        self.c_convolve = QtWidgets.QComboBox(SpectraFit)
        self.c_convolve.setObjectName("c_convolve")
        self.grid_model.addWidget(self.c_convolve, 2, 1, 1, 1)
        self.l_convolve = QtWidgets.QLabel(SpectraFit)
        self.l_convolve.setObjectName("l_convolve")
        self.grid_model.addWidget(self.l_convolve, 2, 0, 1, 1)

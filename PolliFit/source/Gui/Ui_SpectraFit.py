...
class Ui_SpectraFit(object):
    def setupUi(self, SpectraFit):
        ...
        self.vert_options.setGeometry(QtCore.QRect(0, -90, 289, 557))
        ...
        self.b_adjust = QtWidgets.QPushButton(self.grid_fit)
        self.b_adjust.setObjectName("b_adjust")
        self.hor_adjust.addWidget(self.b_adjust)
        self.check_iterate = QtWidgets.QCheckBox(self.grid_fit)
        self.check_iterate.setObjectName("check_iterate")
        self.hor_adjust.addWidget(self.check_iterate)
        self.hor_adjust.setStretch(0, 1)
        self.grid_fit_layout.addLayout(self.hor_adjust, 5, 0, 1, 1)
        self.hor_iterate = QtWidgets.QHBoxLayout()
        self.hor_iterate.setSpacing(3)
        self.hor_iterate.setObjectName("hor_iterate")
        self.l_iterate = QtWidgets.QLabel(self.grid_fit)
        self.l_iterate.setObjectName("l_iterate")
        self.hor_iterate.addWidget(self.l_iterate)
        self.d_volt = QtWidgets.QDoubleSpinBox(self.grid_fit)
    ...
    def retranslateUi(self, SpectraFit):
        ...
        self.b_adjust.setText(_translate("SpectraFit", "adjust U/f0"))
        self.check_iterate.setText(_translate("SpectraFit", "iterate"))
        self.l_iterate.setText(_translate("SpectraFit", "<"))
        self.d_volt.setSuffix(_translate("SpectraFit", " V"))
        self.label.setText(_translate("SpectraFit", "&"))
        self.d_mhz.setSuffix(_translate("SpectraFit", " MHz"))

...
class Ui_SpectraFit(object):
    def setupUi(self, SpectraFit):
        ...
        self.grid_options.addWidget(self.check_save_ascii, 4, 1, 1, 1)
        ...
        self.grid_options.addWidget(self.check_hf_mixing, 3, 1, 1, 1)
        ...
        self.grid_options.addWidget(self.check_qi, 3, 0, 1, 1)
